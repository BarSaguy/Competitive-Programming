...
int values[16] = {13439, 53032, 63093, 26516, 66019, 64824, 15152, 13258, 21031, 56072, 44224, 32412, 20288, 7576, 44673, 6629};
...
void solve(){
    ...
    rep(n){
        rep(j, m){
            cin >> mat[i][j];
            if((i+j)%2) mat[i][j] = 720720;
            else{
                mat[i][j] = mat[i][j]*values[mat[i][j]-1];
            }
            cout << mat[i][j] << " ";
        }
        cout << endl;
